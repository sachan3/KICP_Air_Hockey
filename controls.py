...
def position_function(dt, puckCoordX, puckCoordY, robotCoordX, robotCoordY):
    ...
    dx = puckCoordX - xpos_old
    
    dy = puckCoordY - ypos_old
    ...
    if abs(m) < 0.05:
       ...
       target_x_new = (puckCoordY - 180)/m + puckCoordX
    ...
    print("m is ", m)
    print("x-coordinate", target_x_new)
...
with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
    ...
    with conn:
        ...
        while True:
            ...
            target_x_new, target_y_new, max_speed, max_accel, robotCoordX, robotCoordY = position_function(dt, puckCoordX, puckCoordY, robotCoordX, robotCoordY)
